...
class PythonConfig:
    ...
    def get_cfgs():
        env_cfg = {
            ...
            "action_noise_range": 0.005,            # Action noise range as a fraction of max action (e.g., 0.1 for ±10% noise)
        ...
        reward_cfg = {
            ...
            "odometry_penalty": 3.0,           # Matches:  * 1
            "steering_change_penalty": - 0, # Matches:  * 1
