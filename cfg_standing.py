...
class PythonConfig:
    ...
    def get_cfgs():
        env_cfg = {
            ...
            "termination_if_posX_greater_than": 0.1, # meters
        ...
        reward_cfg = {
            ...
            "upright_posture": 3.0,     # Matches: * 1
            "angular_vel_penalty": -10.0, # Matches: * abs(angular_vel)
            "pos_penalty": -3.0,           # Matches:  * 1
            "steering_change_penalty": -0.4, # Matches:  * 1
            "torque_change_penalty": -0.5,   # Matches: * 1
        }
