...
# model = PPO.load("two_wheel_robot/results/stop_withCon_v3/kourin21_con", env=env)
...
while True:
    ...
    # print("action:", np.rad2deg(action[0]*np.deg2rad(80)), action_num, action[1])
    # print("imu", np.rad2deg(obs[0]))
    # print(obs[2], obs[3], counter)
    print(env.TARGET_xVEL, obs[2]*0.031, env.total_Xpos, env.total_Ypos, counter)
